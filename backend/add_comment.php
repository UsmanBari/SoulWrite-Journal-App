    ...
    if ($journal_owner_id != $user_id) {
        try {
            ...
            if ($notif_stmt->execute()) {
                error_log("✅ Comment notification created for user $journal_owner_id");
                ...
                if (file_exists(__DIR__ . '/send_notification.php')) {
                    ...
                    error_log("❌ send_notification.php not found");
                }
            } else {
        ...
        error_log("ℹ️ Not sending notification - user commented on own journal");
    }
